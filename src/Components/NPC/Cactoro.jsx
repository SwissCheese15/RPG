...
Command: npx gltfjsx@6.1.4 Cactoro.gltf --transform
*/
...
export function Cactoro(props) {
  const group = useRef()
  const group2 = useRef()
  const { nodes, materials, animations } = useGLTF('/Models/Monsters/Cactoro-transformed.glb')
  const { actions } = useAnimations(animations, group)

  useEffect(() => {
    console.log(group.current.position.z = props.z)
  }, [])

  return (<>
    <group ref={group} {...props} dispose={null}>
        <group name="Scene" position={[10, 0, 10]}>
        ...
        <group name="Scene" position={[5, 0, 5]}>
            <group name="CharacterArmature">
            <primitive object={nodes.Body} />
            <primitive object={nodes.Head} />
            <group name="Cactoro_Blob">
...
useGLTF.preload('/Models/Monsters/Cactoro-transformed.glb')
